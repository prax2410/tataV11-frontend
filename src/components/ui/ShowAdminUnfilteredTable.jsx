...
const ShowAdminUnfilteredTable = ({ data }) => {
            ...
            {data && Object.keys(data).map((rows, i) => {
                return (
                    <tr key={i}>
                        ...
                        <td>{data[rows].apmaxdemand}</td>
                        <td>{data[rows].apmindemand}</td>
                        <td>{data[rows].rpmaxdemand}</td>
                        <td>{data[rows].rpmindemand}</td>
                        <td>{data[rows].appmaxdemand}</td>
                        <td>{data[rows].impactenergy}</td>
                        <td>{data[rows].expactenergy}</td>
                        <td>{data[rows].totactenergy}</td>
                        <td>{data[rows].impreaenergy}</td>
                        <td>{data[rows].expreaenergy}</td>
                        <td>{data[rows].totreaenergy}</td>
                        <td>{data[rows].totappenergy}</td>
...
export default ShowAdminUnfilteredTable;