...
import ShowAdminUnfilteredTable from '../components/ui/ShowAdminUnfilteredTable';
import ShowAdminFilteredTable from '../components/ui/ShowAdminFilteredTable';
...
const AdminReportsPage = () => {
    ...
    const getFilteredReportDataFromDb = useCallback(async () => {
        ...
        const filteredDateFrom = periodFrom + 'T' + timeFrom + '.000Z';
        const filteredDateTo = periodTo + 'T' + timeTo + '.000Z';
        ...
        <Layout>
            <div className='reports--container'>
                <div className="reports--header">
                    ...
                    {/* Email button */}
                    <button className='reports--header-button' onClick={(e) => handleEmailButton(e)}>
                        <p>Email</p>
                        <AiOutlineMail />
                    </button>

                    {/* Download button */}
                    <button className='reports--header-button' onClick={(e) => handleDownloadButton(e)}>
                        <p>Download</p>
                        <BsDownload />
                    </button>
                </div>
                    ...
                    {loading ?
                        (
                            ...
                            <table>
                                ...
                                {!periodFrom && !periodTo && machineNames
                                    ? <ShowAdminUnfilteredTable data={unfilteredData} />
                                    : <ShowAdminFilteredTable data={filteredData} />
                                }
                            </table>
                        )}
                </div>
